...
COMPUTER_USE_GUIDANCE = (
    ...
    "IMPORTANT: After verify screenshot shows cursor is on the correct element, "
    "click IMMEDIATELY — do NOT move the cursor again. If you move after verify, "
    "you will miss the target. The pattern is: move, verify, click. Not: move, verify, move, click.\n"
    "The screenshot includes the mouse cursor and reports 'Cursor at (x, y)' in the result.\n"
    "If cursor is NOT on the right element, adjust with another mouse_move and re-verify.\n"
    "For right-click menus: mouse_move to element, verify, right_click, screenshot to see menu, "
    "then mouse_move to menu item, verify it is highlighted, left_click.\n"
